...
export class CumuluseClient {
  ...
  async diagnostics(runId: string): Promise<{ path: string; bundlePath: string }> {
    return this.json(`/v1/runs/${encodeURIComponent(runId)}/diagnostics`);
  }
